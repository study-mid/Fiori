		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "항공편 조회(B12)",
									"targetURL": "#examexprogramb12-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"examexprogramb12-display": {
								"semanticObject": "examexprogramb12",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exam.exprogramb12",
									"url": sap.ui.require.toUrl("exam/exprogramb12")
								}
							}
						}
					}
