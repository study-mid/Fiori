		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My App",
									"targetURL": "#projectb1210-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectb1210-display": {
								"semanticObject": "projectb1210",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectb1210",
									"url": sap.ui.require.toUrl("projectb1210")
								}
							}
						}
					}
