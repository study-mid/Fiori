					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[TAEDONG-PP] 공정 관리 ",
									"targetURL": "#zbcpp110-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zbcpp110-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbcpp110",
									"url": sap.ui.require.toUrl("zbcpp110")
								}
							}
						}
					}
