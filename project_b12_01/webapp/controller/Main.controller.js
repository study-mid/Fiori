...
//         return Controller.extend("projectb1201.controller.Main", {
//             onInit: function () {
...
sap.ui.define([
	...
	return Controller.extend("projectb1201.controller.Main", {
        ...
        onClick: function(){
            // alert('버튼 클릭');
            var oText = this.byId('idText'); // 텍스트 객체 가져옴
            var sText = oText.getValue(); // 텍스트 객체에서 text property 값을 가져옴
		...
		initSampleDataModel: function() {
			...
			jQuery.ajax(sap.ui.require.toUrl("project_b12_01\webapp\model\products.json"), {
				dataType: "json",
