		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#odatacrudb12-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"odatacrudb12-display": {
								"semanticObject": "odatacrudb12",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=odatacrudb12",
									"url": sap.ui.require.toUrl("odatacrudb12")
								}
							}
						}
					}
