      ...
      services: {
                  ...
                  tiles: [
                    {
                      ...
                      properties: {
                        title: "App Title",
                        targetURL: "#testprojectb1203-display",
                      },
                    },
                  ],
                },
        ...
        ClientSideTargetResolution: {
          adapter: {
            config: {
              inbounds: {
                "testprojectb1203-display": {
                  semanticObject: "testprojectb1203",
                  action: "display",
                  ...
                  resolutionResult: {
                    ...
                    additionalInformation: "SAPUI5.Component=test.projectb1203",
                    url: sap.ui.require.toUrl("test/projectb1203"),
                  },
                },
              },
            },
